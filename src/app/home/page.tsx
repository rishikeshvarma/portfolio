    ...
    <Column maxWidth="m">
      ...
      {about.tableOfContent.display && (
        <Column
          ...
          gap="32"
          hide="s"
          className={styles.tocMobileHide}
        >
          <TableOfContents structure={structure} about={about} />
        </Column>
      )}
      {isMobile ? (
        <Column style={{ width: '100%', alignItems: 'center' }} gap="m">
          {about.avatar.display && (
            <>
              <Avatar src={person.avatar} size="xl" />
              <Flex gap="8" vertical="center" marginTop="s">
                <Icon onBackground="accent-weak" name="globe" />
                {person.location}
              </Flex>
              {person.languages.length > 0 && (
                <Flex wrap gap="8" marginBottom="s">
        ...
        <Flex fillWidth mobileDirection="column" horizontal="space-between">
        {about.avatar.display && (
          <Column
